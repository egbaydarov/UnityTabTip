...
public class GvrLaserHandPointer : GvrBasePointer
{
    ...
    public override bool TriggerDown => isPinching;
    public override bool TriggerUp => !isPinching;
    public override bool Triggering => isPinching;
}
